  ...
  grunt.initConfig({
    ...
    concat: {
      release: {
	      files: [
		      {src: [
            'www/scripts/googleanalytics.js',
            'www/library/underscore.deferred.js',
            'www/library/underscore.math.js',
            'www/library/miso.events.js',
            'www/library/miso.ds.0.4.1.js',
            'www/scripts/spriteAnimation.js',
            'www/scripts/countdowns.js',
            'www/scripts/pagemanager.js',
            'www/scripts/CountdownCtrl.js',
            'www/scripts/scammerController.js',
            'www/scripts/spriteAniObj.js',
            'www/scripts/memberpageCtrl.js'
